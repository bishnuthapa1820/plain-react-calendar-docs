    ...
    <div className="mt-[80px]">
      ...
      <div className="mt-8">
        <p className="_description">
          After installing the library, just import it and create a state to
          store the date. If you don't want the default date, you can set null
          value instead of date. Here the date should be a string or list of
          string or null value. And it must be a string separated by "-" like
          "2023-05-25".{" "}
          ...
          Here the value and onChange are two props that are compulsory; value
          could be a string or list of string or null, and onChange is the
          function that accepts a parameter, and its parameter is always a list
          of dates.
        </p>
        <img
          src={calenderBasicUse}
          alt="calender-basic-use"
          className="mt-4 rounded-sm w-full max-w-[800px]"
        />
      </div>
